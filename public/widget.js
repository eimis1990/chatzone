...
;(function () {
  ...
  var LAUNCHER_ICONS = {
    ...
    'smile-bubble': strokedIcon(
      '<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/><path d="M9 13.5s1.1 1.5 3 1.5 3-1.5 3-1.5"/><path d="M9.5 9.5h.01"/><path d="M14.5 9.5h.01"/>'
    ),
