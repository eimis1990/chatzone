...
export type SuggestedQuestion =
  | string
  | { label: string; prompt?: string; url?: string; query?: string; action?: SuggestedQuestionAction }
...
export interface BotConfig {
  ...
  theme: {
    ...
    launcherIcon?: 'chat' | 'message-circle' | 'message-dots' | 'smile-bubble' | 'sparkles' | 'headset' | 'bot' | 'zap' | 'smile' | 'shopping-bag'
...
export type ConversationChannel = 'chat' | 'voice' | 'messenger' | 'instagram'
