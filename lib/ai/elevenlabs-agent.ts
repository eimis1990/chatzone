...
export function agentConfigHash(bot: Bot, toolIds: string[] = []): string {
  ...
  const material = JSON.stringify([
    'v31-color-constraints', // bump to force re-sync when the agent payload shape changes
