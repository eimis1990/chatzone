...
/**
 * Dark pill button with an accent chevron tray that sweeps across on hover
 * (Antimetal-style). Defaults are tuned to Loqara's orange.
 */
  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={cn(
          'group/btn relative inline-flex h-11 w-48 overflow-hidden rounded-xl transition-transform active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background',
