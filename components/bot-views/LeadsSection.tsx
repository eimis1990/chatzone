...
/**
 * Shared Leads view — used by the client bot pages AND the owner's platform-bot
 * section. Callers do the role guard + bot resolution; the leads read goes
 * through the RLS server client (org-membership scoped).
 */
export async function LeadsSection({ bot }: { bot: Pick<Bot, 'id' | 'name'> }) {
