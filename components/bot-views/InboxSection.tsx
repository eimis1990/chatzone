...
/**
 * Shared Inbox view — used by the client bot pages AND the owner's platform-bot
 * section. Callers do the role guard + bot resolution; every read/write here
 * goes through the RLS server client, so org membership (client, or the owner's
 * platform-org membership) is what actually scopes the data.
 */
...
export async function InboxSection({ botId }: { botId: string }) {
