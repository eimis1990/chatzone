...
Re:amaze is a capable multichannel helpdesk with native e-commerce order actions right in the chat, priced per user at $29–$69/user/month with AI included in paid plans up to a resolution cap ([Re:amaze pricing](https://www.reamaze.com/pricing)). A sensible middle option if you want a traditional inbox with lighter AI than Fin or Gorgias and a gentler bill than Intercom.
...
Powerful and endlessly configurable, but heavy and expensive for most stores — Suite plans run $19–$115/agent/month, AI agents are included but usage-billed per automated resolution, and the agent-facing Copilot is a $50/agent/month add-on ([Zendesk pricing](https://www.zendesk.com/pricing/)). Really only worth it if you're already standardised on Zendesk company-wide. If you landed here because Intercom felt enterprise, Zendesk won't feel lighter; see [Zendesk alternatives](/blog/zendesk-alternatives-for-ecommerce).
