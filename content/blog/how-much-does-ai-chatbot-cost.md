...
<ul>
<li><strong>The model beats the sticker price:</strong> per-seat, per-resolution, and per-conversation billing produce very different bills on identical traffic.</li>
<li><strong>Volume and channels drive cost more than features:</strong> how many customers message you, and on how many channels, moves the number most.</li>
<li><strong>Watch the hidden fees:</strong> setup and onboarding charges, per-seat minimums, and generously-defined "resolutions" are where budgets slip.</li>
<li><strong>Estimate before you buy:</strong> take your real monthly conversation count and run it through each vendor's pricing unit — a real free tier lets you test on actual traffic first.</li>
</ul>
</div>

<figure>
<img src="/blog/how-much-does-ai-chatbot-cost.webp" alt="Illustration of AI chatbot pricing: a chat bubble beside a price tag, coins, and a calculator, representing the cost of an AI chatbot for an online store" width="1200" height="800" loading="lazy" />
<figcaption>The headline price tells you almost nothing — the pricing unit underneath it decides your bill.</figcaption>
</figure>
...
<figure>
<img src="/blog/ai-chatbot-cost-breakdown.webp" alt="Breakdown of what drives AI chatbot cost: conversation volume, channels, AI resolutions versus conversations, support seats, and setup or onboarding fees" width="1200" height="800" loading="lazy" />
<figcaption>Five levers move the price: volume, channels, the AI billing unit, seats, and setup fees.</figcaption>
</figure>
...
- **Add-ons for the basics.** The AI itself, extra channels, or voice can each be separate paid modules. Loqara, for instance, includes grounded chat in the base plan and treats [voice](/blog/best-ai-chatbot-for-ecommerce) as an optional add-on — so you only pay for it if you want customers to talk to your store.
- **The cost of a bad bot.** An ungrounded chatbot that invents policies creates tickets instead of closing them. Cheaper on paper, expensive in practice — the real return comes from [deflecting repetitive tickets](/blog/reduce-support-tickets-with-ai), which is worth measuring with proper [ROI metrics](/blog/chatbot-roi-metrics-that-matter).

## How do I estimate my own cost?

Skip the pricing-page math and start from your own numbers:

1. **Count your real monthly conversations.** Pull how many customer threads you get in an average month from your current inbox or chat tool. This is your baseline unit.
2. **Estimate the AI's share.** Roughly what fraction are repetitive questions the AI could handle — order status, sizing, returns? That's your likely "resolution" count.
3. **Translate every quote into your traffic.** For each vendor, multiply your numbers through *their* unit — per seat, per resolution, or per conversation. Now you're comparing like with like.
...
[Try Loqara free on your store](/#get-started) — 100 conversations a month, no credit card, live the same day.
